...
public class MemberService {
    ...
    //add a new member and write the updated list over the old one in out file store
    // to update a member:
    ...
    // more edges cases exist like view by family, view by expired/active(not included in membership class)

    public static void main(String[] args) {
        // ** validation and error handling **
        // ^^ need to be considered and implemented
        // ** member list file versioning? will we save previous versions of the member list for data integrity purposes? **
        ...
        switch (choice) {
            case 1:
                ...
                // this case is also incomplete, scans for a membership type required
            ...
            case 2:
                ...
                //^^ would you like to change name from {member.getName()}? y or n (if yes, enter new name) for each field
            ...
            case 3:
                ...
                // ^^^ we will also have to scrub any other files ( tournament, registration, etc) for references to this member 
                // ^^^ otherwise unwanted errors could occur
                // if we decide to implement this we will remove the member from the list at this point and then write the list to the file
                break;
            case 4:
                ...
                // this option will also ask if another lookup is required before returning to the main menu
                break;
