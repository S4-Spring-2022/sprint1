...
class Demo {
    ...
    Member newMember = new Member("Barry", "Poole", "101 new way", "barry@barry", "709-550-1102", LocalDate.of(2020, Month.JUNE, 21));
        ...
        System.out.println("Member First Name: "+ newMember.getMemberFirstName("FirstName"));
        System.out.println("Member Last Name: "+ newMember.getMemberLastName("LastName"));
        System.out.println("Member Address: "+ newMember.getMemberAddress("Place") );
        System.out.println("Member Email: "+ newMember.getEmail("Email@Email"));
        System.out.println("Member Phone: "+ newMember.getPhoneNumber("747-3458"));
